          ...
          inputs: [
            {
              ...
              suffixIconButtons: [
                {
                  ...
                  clickAction: (input) => {
                    ...
                    // generate
                    data.itemData.visualId = ContactModel.generateContactIDMask(data.selectedOutbreak.contactIdMask);
              ...
              validators: {
                async: new Observable((observer) => {
                  ...
                  TimerCache.run(
                    cacheKey,
                    data.contactDataService.checkContactVisualIDValidity(
              ...
              replace: {
                ...
                html: data.i18nService.instant('LNG_PAGE_CREATE_CONTACT_CANT_SET_RESPONSIBLE_ID_TITLE')
              }
            }
          ]
        },
            ...
            actionIconButtons: [
              // copy parent address
              {
                ...
                click: (
                  ...
                  data.dialogV2Service.showConfirmDialog({
                    config: {
                      title: {
