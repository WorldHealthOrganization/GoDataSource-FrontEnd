...
export enum ApplyListFilter {
    ...
    CONTACTS_WITHOUT_RELATIONSHIPS  = 'contacts_without_relationships'
}
...
export class Constants {
    ...
    static LIST_FILTER_TITLE = {
        ...
        [Constants.APPLY_LIST_FILTER.CONTACTS_WITHOUT_RELATIONSHIPS]: 'LNG_PAGE_DASHBOARD_CONTACTS_WITHOUT_RELATIONSHIPS'
    };
