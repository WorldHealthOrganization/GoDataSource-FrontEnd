...
export class CasesDateOnsetListComponent extends ListComponent implements OnInit {
    ...
    casesWithOnsetModel$: Observable<CasesWithOnsetModel[]>;
    ...
    refreshList() {
        if (this.selectedOutbreak) {
            // retrieve the list
            this.casesWithOnsetModel$ = this.relationshipDataService.getCasesWithDateOnsetBeforePrimaryCase(this.selectedOutbreak.id);
        }
    }
