...
export class AvailableEntitiesForSwitchListComponent extends ListComponent<CaseModel | ContactModel | EventModel | ContactOfContactModel, IV2Column> implements OnDestroy {
  // entity
