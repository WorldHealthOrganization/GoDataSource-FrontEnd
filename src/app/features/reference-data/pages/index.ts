...
import {
  ReferenceDataCategoryEntriesPerDiseaseViewModifyComponent
} from './reference-data-category-entries-per-disease-view-modify/reference-data-category-entries-per-disease-view-modify.component';
...
export * from './reference-data-category-entries-per-disease-view-modify/reference-data-category-entries-per-disease-view-modify.component';
