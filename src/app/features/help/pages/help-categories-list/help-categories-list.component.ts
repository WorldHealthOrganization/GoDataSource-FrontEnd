...
export class HelpCategoriesListComponent extends ListComponent<HelpCategoryModel, IV2Column> implements OnDestroy {
  /**
   * Constructor
   */
  constructor(
  ...
  protected initializeTableColumns(): void {
    ...
    this.tableColumns = [
      ...
      {
        field: 'createdOn',
        label: 'LNG_HELP_CATEGORY_FIELD_LABEL_CREATED_ON',
        notVisible: true,
        format: {
      ...
      {
        field: 'createdBy',
        label: 'LNG_HELP_CATEGORY_FIELD_LABEL_CREATED_BY',
        notVisible: true,
        format: {
      ...
      {
        field: 'createdAt',
        label: 'LNG_HELP_CATEGORY_FIELD_LABEL_CREATED_AT',
        notVisible: true,
        format: {
      ...
      {
        field: 'updatedBy',
        label: 'LNG_HELP_CATEGORY_FIELD_LABEL_UPDATED_BY',
        notVisible: true,
        format: {
      ...
      {
        field: 'updatedAt',
        label: 'LNG_HELP_CATEGORY_FIELD_LABEL_UPDATED_AT',
        notVisible: true,
        format: {
          type: V2ColumnFormat.DATETIME
        },
