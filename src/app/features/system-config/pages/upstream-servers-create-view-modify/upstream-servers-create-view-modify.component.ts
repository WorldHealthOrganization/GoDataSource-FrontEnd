...
export class UpstreamServersCreateViewModifyComponent extends CreateViewModifyComponent<SystemUpstreamServerModel> implements OnDestroy {
  ...
  protected initializeTabs(): void {
    this.tabData = {
      ...
      create: {
        finalStep: {
          buttonLabel: this.createViewModifyHelperService.i18nService.instant('LNG_PAGE_CREATE_SYSTEM_UPSTREAM_SERVER_ACTION_CREATE_UPSTREAM_SERVER_BUTTON'),
        ...
        .subscribe((settings: SystemSettingsModel) => {
          ...
          this.systemSettingsDataService
            ...
            .subscribe(() => {
              ...
              this.createViewModifyHelperService.toastV2Service.success('LNG_PAGE_CREATE_SYSTEM_UPSTREAM_SERVER_ACTION_CREATE_UPSTREAM_SERVER_SUCCESS_MESSAGE');
