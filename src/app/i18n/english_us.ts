...
export const EnglishUsLang = {
    ...
    tokens: {
        ...
        'LNG_LAYOUT_MENU_ITEM_TERMS_OF_USE': 'Terms of Use',
        'LNG_LAYOUT_MENU_ITEM_LANGUAGES': 'Languages',
        'LNG_LAYOUT_MENU_ITEM_HELP_ADMIN': 'Manage Help Categories',
        ...
        'LNG_LAYOUT_MENU_ITEM_DATA_VISUALISATION': 'Data visualisation',
        ...
        'LNG_LAYOUT_MENU_ITEM_TRANSMISSION_CHAINS_GEO_MAP_LABEL': 'Geospacially Map',
        ...
        'LNG_FORM_VALIDATION_ERROR_FIELD_URL': 'Invalid URL, should not contain "localhost"',
        ...
        'LNG_API_ERROR_CODE_UPSTREAM_SERVER_SYNC_IN_PROGRESS': 'Only a sync action can be in progress at a time',
        ...
        'LNG_ADDRESS_FIELD_LABEL_TYPE_DESCRIPTION': '',
        'LNG_ADDRESS_FIELD_LABEL_DATE': 'Date',
        'LNG_ADDRESS_FIELD_LABEL_DATE_DESCRIPTION': '',
        ...
        'LNG_DOCUMENT_FIELD_LABEL_DOCUMENT_TYPE_DESCRIPTION': '',
        ...
        'LNG_CASE_FIELD_LABEL_DATE_OF_INFECTION_DESCRIPTION': '',
        'LNG_CASE_FIELD_LABEL_DATE_OF_OUTCOME': 'Date of Outcome',
        'LNG_CASE_FIELD_LABEL_DATE_OF_OUTCOME_DESCRIPTION': '',
        'LNG_CASE_FIELD_LABEL_AGE': 'Age',
        'LNG_CASE_FIELD_LABEL_AGE_DESCRIPTION': '',
        'LNG_CASE_FIELD_LABEL_FIRST_NAME': 'First Name',
        'LNG_CASE_FIELD_LABEL_FIRST_NAME_DESCRIPTION': '',
        'LNG_CASE_FIELD_LABEL_DATE_OF_ONSET': 'Date of Onset',
        'LNG_CASE_FIELD_LABEL_DATE_OF_ONSET_DESCRIPTION': '',
        'LNG_CASE_FIELD_LABEL_IS_DATE_OF_ONSET_APPROXIMATE': 'Is date of onset approximate?',
        'LNG_CASE_FIELD_LABEL_IS_DATE_OF_ONSET_APPROXIMATE_DESCRIPTION': '',
        'LNG_CASE_FIELD_LABEL_RISK_REASON': 'Risk Reason',
        'LNG_CASE_FIELD_LABEL_RISK_REASON_DESCRIPTION': '',
        'LNG_CASE_FIELD_LABEL_RISK_LEVEL': 'Risk level',
        'LNG_CASE_FIELD_LABEL_RISK_LEVEL_DESCRIPTION': '',
        'LNG_CASE_FIELD_LABEL_HOSPITALIZATION_DATES': 'Hospitalization Dates',
        'LNG_CASE_FIELD_LABEL_HOSPITALIZATION_DATES_FROM_DESCRIPTION': '',
        'LNG_CASE_FIELD_LABEL_HOSPITALIZATION_DATES_TO_DESCRIPTION': '',
        'LNG_CASE_FIELD_LABEL_HOSPITALIZATION_DATES_CENTER_NAME': 'Hospital Name',
        'LNG_CASE_FIELD_LABEL_HOSPITALIZATION_DATES_CENTER_NAME_DESCRIPTION': '',
        'LNG_CASE_FIELD_LABEL_CENTER_DATES_LOCATION': 'Location',
        'LNG_CASE_FIELD_LABEL_CENTER_DATES_LOCATION_DESCRIPTION': '',
        'LNG_CASE_FIELD_LABEL_CENTER_DATES_COMMENTS': 'Comments',
        'LNG_CASE_FIELD_LABEL_CENTER_DATES_COMMENTS_DESCRIPTION': '',
        'LNG_CASE_FIELD_LABEL_ID': 'ID',
        'LNG_CASE_FIELD_LABEL_DOB': 'Date of Birth',
        'LNG_CASE_FIELD_LABEL_DOB_DESCRIPTION': '',
        'LNG_CASE_FIELD_LABEL_DATE_BECOME_CASE': 'Date of Becoming case',
        'LNG_CASE_FIELD_LABEL_DATE_BECOME_CASE_DESCRIPTION': '',
        ...
        'LNG_CASE_FIELD_LABEL_ISOLATION_DATES_FROM_DESCRIPTION': '',
        ...
        'LNG_CASE_FIELD_LABEL_DATE_OF_REPORTING_DESCRIPTION': '',
        'LNG_CASE_FIELD_LABEL_DATE_OF_REPORTING_APPROXIMATE': 'Is Date of reporting approximate',
        'LNG_CASE_FIELD_LABEL_DATE_OF_REPORTING_APPROXIMATE_DESCRIPTION': '',
        ...
        'LNG_CASE_LAB_RESULT_FIELD_LABEL_DATE_SAMPLE_TAKEN_DESCRIPTION': '',
        'LNG_CASE_LAB_RESULT_FIELD_LABEL_DATE_SAMPLE_DELIVERED': 'Sample delivered to lab',
        'LNG_CASE_LAB_RESULT_FIELD_LABEL_DATE_SAMPLE_DELIVERED_DESCRIPTION': '',
        'LNG_CASE_LAB_RESULT_FIELD_LABEL_DATE_TESTING': 'Date testing',
        'LNG_CASE_LAB_RESULT_FIELD_LABEL_DATE_TESTING_DESCRIPTION': '',
        'LNG_CASE_LAB_RESULT_FIELD_LABEL_DATE_OF_RESULT': 'Date of the result',
        'LNG_CASE_LAB_RESULT_FIELD_LABEL_DATE_OF_RESULT_DESCRIPTION': '',
        'LNG_CASE_LAB_RESULT_FIELD_LABEL_LAB_NAME': 'Lab name',
        'LNG_CASE_LAB_RESULT_FIELD_LABEL_LAB_NAME_DESCRIPTION': '',
        'LNG_CASE_LAB_RESULT_FIELD_LABEL_SAMPLE_TYPE': 'Sample type',
        'LNG_CASE_LAB_RESULT_FIELD_LABEL_SAMPLE_TYPE_DESCRIPTION': '',
        ...
        'LNG_CASE_LAB_RESULT_FIELD_LABEL_STATUS_DESCRIPTION': '',
        ...
        'LNG_CLUSTER_FIELD_LABEL_NAME_DESCRIPTION': '',
        'LNG_CLUSTER_FIELD_LABEL_DESCRIPTION': 'Description',
        'LNG_CLUSTER_FIELD_LABEL_DESCRIPTION_DESCRIPTION': '',
        ...
        'LNG_USER_FIELD_LABEL_FIRST_NAME_DESCRIPTION': '',
        'LNG_USER_FIELD_LABEL_LAST_NAME': 'Last Name',
        'LNG_USER_FIELD_LABEL_LAST_NAME_DESCRIPTION': '',
        ...
        'LNG_USER_ROLE_FIELD_LABEL_NAME_DESCRIPTION': '',
        'LNG_USER_ROLE_FIELD_LABEL_DESCRIPTION': 'Description',
        'LNG_USER_ROLE_FIELD_LABEL_DESCRIPTION_DESCRIPTION': '',
        'LNG_USER_ROLE_FIELD_LABEL_PERMISSIONS': 'Options',
        'LNG_USER_ROLE_FIELD_LABEL_PERMISSIONS_DESCRIPTION': '',
        ...
        'LNG_CONTACT_FIELD_LABEL_DOB_DESCRIPTION': '',
        ...
        'LNG_PAGE_LIST_CONTACTS_EXPORT_FOLLOW_UPS_GROUP_BY_BUTTON': 'Group by',
        ...
        'LNG_RELATIONSHIP_FIELD_LABEL_CONTACT_DATE_ESTIMATED_DESCRIPTION': '',
        'LNG_RELATIONSHIP_FIELD_LABEL_CERTAINTY_LEVEL': 'Certainty Level',
        'LNG_RELATIONSHIP_FIELD_LABEL_CERTAINTY_LEVEL_DESCRIPTION': '',
        'LNG_RELATIONSHIP_FIELD_LABEL_EXPOSURE_TYPE': 'Exposure Type',
        'LNG_RELATIONSHIP_FIELD_LABEL_EXPOSURE_TYPE_DESCRIPTION': '',
        ...
        'LNG_RELATIONSHIP_FIELD_LABEL_COMMENT_DESCRIPTION': '',
        ...
        'LNG_PAGE_LIST_FOLLOW_UPS_PRINT_DAILY_FORM_TITLE': 'Print Follow-up List',
        ...
        'LNG_PAGE_LIST_FOLLOW_UPS_EXPORT_GROUP_BY_BUTTON': 'Group by',
        ...
        'LNG_REFERENCE_DATA_CATEGORY_TYPE_OF_LAB_TEST': 'Type Of Lab Test',
        ...
        'LNG_REFERENCE_DATA_ENTRY_FIELD_LABEL_VALUE_DESCRIPTION': '',
        'LNG_REFERENCE_DATA_ENTRY_FIELD_LABEL_DESCRIPTION': 'Description',
        'LNG_REFERENCE_DATA_ENTRY_FIELD_LABEL_DESCRIPTION_DESCRIPTION': '',
        'LNG_REFERENCE_DATA_ENTRY_FIELD_LABEL_ICON': 'Icon',
        'LNG_REFERENCE_DATA_ENTRY_FIELD_LABEL_ICON_DESCRIPTION': '',
        'LNG_REFERENCE_DATA_ENTRY_FIELD_LABEL_COLOR': 'Color',
        'LNG_REFERENCE_DATA_ENTRY_FIELD_LABEL_COLOR_DESCRIPTION': '',
        'LNG_REFERENCE_DATA_ENTRY_FIELD_LABEL_ACTIVE': 'Active',
        'LNG_REFERENCE_DATA_ENTRY_FIELD_LABEL_ACTIVE_DESCRIPTION': '',
        'LNG_REFERENCE_DATA_ENTRY_FIELD_LABEL_SYSTEM_VALUE': 'System Value',
        'LNG_REFERENCE_DATA_ENTRY_FIELD_LABEL_READONLY_DESCRIPTION': '',
        ...
        'LNG_ICON_FIELD_LABEL_NAME_DESCRIPTION': '',
        ...
        'LNG_OUTBREAK_FIELD_LABEL_LOCATION_GEOGRAPHICAL_LEVEL': 'Location Geographical Level',
        'LNG_OUTBREAK_FIELD_LABEL_LOCATION_GEOGRAPHICAL_LEVEL_DESCRIPTION': '',
        ...
        'LNG_PAGE_DASHBOARD_KPI_CONTACTS_WITH_SUCCESSFUL_FOLLOW_UP': 'CONTACTS WITH SUCCESSFUL FOLLOW-UP',
        ...
        'LNG_PAGE_DASHBOARD_KPI_CONTACTS_SEEN_EACH_DAY' : 'CONTACTS SEEN',
        ...
        'LNG_PAGE_DASHBOARD_CASE_BY_GEOGRAPHIC_LOCATION_TITLE': 'Cases By Geographic Location',
        ...
        'LNG_BACKUP_FIELD_LABEL_USER': 'User',
        ...
        'LNG_AUTOMATIC_BACKUP_FIELD_LABEL_BACKUP_INTERVAL': 'Backup interval (hours)',
        'LNG_AUTOMATIC_BACKUP_FIELD_LABEL_BACKUP_INTERVAL_DESCRIPTION': '',
        'LNG_AUTOMATIC_BACKUP_FIELD_LABEL_RETENTION_INTERVAL': 'Retention interval (days)',
        ...
        'LNG_PAGE_LIST_FILTER_CASES_NOT_IDENTIFIED_THROUGH_CONTACTS': 'Cases not identified through contacts',
         ...
         */
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_TITLE': 'Chains of Transmission',
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_HIERARCHICAL_NETWORK_VIEW': 'Hierarchical Network',
        ...
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_ACTION_VIEW_CHAIN_OF_TRANSMISSION': 'View Person Chain of Transmission',
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_ACTION_VIEW_PERSON': 'View Resource',
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_ACTION_VIEW_PERSON_CHAIN': 'View Chain',
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_RELATIONSHIP_DIALOG_TITLE': 'Relationship Details',
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_NODE_COLOR_TITLE': 'Background Color',
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_NODE_NAME_COLOR_TITLE': 'Label Color',
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_EDGE_COLOR_TITLE': 'Color',
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_EDGE_LABEL_TITLE': 'Label',
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_ENTITY_TYPE_LABEL': 'Entity Type',
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_COLOR_CRITERIA_TIMELINE_VIEW_TOOLTIP': 'Read-only in Timeline View',
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_CASES_WITHOUT_DATE_OF_ONSET_TITLE': 'cases without date of onset',
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_EVENTS_WITHOUT_DATE_TITLE': 'events without date',
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_CONTACTS_WITHOUT_DATE_OF_LAST_CONTACT_TITLE': 'contacts without date of last contact',
        ...
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_BUTTON_CONFIGURE_SETTINGS': 'Configure Settings',
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_BUTTON_APPLY_SETTINGS': 'Generate Graph',
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_BUTTON_RESET_SETTINGS': 'Reset Settings',
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_FILTERS_TITLE': 'Filters',
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_NODE_SETTINGS_TITLE': 'Node Display Options',
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_EDGE_SETTINGS_TITLE': 'Edge Display Options',
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_LABEL_DATE': 'Date',
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_NODE_ICON_TITLE': 'Icon',
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_NODE_LABEL_TITLE': 'Label',
        ...
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_NODE_LABEL_OPTION_INITIALS': 'Initials',
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_NODE_LABEL_OPTION_VISUAL_ID': 'ID',
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_NODE_LABEL_OPTION_CONCATENATED_DETAILS': 'Details',
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_SHOW_LEGEND_LABEL': 'Show Legend',
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_TOGGLE_EDIT_MODE_LABEL': 'Edit Mode',
        ...
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_ACTION_CREATE_RELATIONSHIP_LABEL_EXPOSURE': 'Exposure',
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_ACTION_CREATE_RELATIONSHIP_LABEL_CONTACT': 'Contact',
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_ACTION_CREATE_RELATIONSHIP_BUTTON': 'Create Relationship',
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_ACTION_CREATE_RELATIONSHIP_SUCCESS_MESSAGE': 'Relationship created!',
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_ACTION_CREATE_CONTACT_LABEL_CONTACT_FIELDS': 'Contact info',
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_ACTION_CREATE_CONTACT_LABEL_RELATIONSHIP_FIELDS': 'Relationship info',
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_ACTION_CREATE_CONTACT_BUTTON': 'Create Contact',
        ...
        'LNG_PAGE_IMPORT_DATA_ERROR_RECORD_ADDRESS_MULTIPLE_USUAL_PLACE_OF_RESIDENCE': 'Failed to import record {{recordNo}} because there are multiple usual place of addresses',
        'LNG_PAGE_IMPORT_DATA_ERROR_RECORD_ADDRESS_PREVIOUS_PLACE_OF_RESIDENCE_MUST_HAVE_DATE': 'Failed to import record {{recordNo}} because previous address should have date',
