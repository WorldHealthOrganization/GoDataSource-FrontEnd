...
export const EnglishUsLang = {
    ...
    tokens: {
        ...
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_NODE_LABEL_OPTION_AGE_YEARS': 'Age (years)',
        'LNG_PAGE_GRAPH_CHAINS_OF_TRANSMISSION_NODE_LABEL_OPTION_AGE_MONTHS': 'Age (months)',
