...
export const EnglishUsLang = {
    ...
    tokens: {
        ...
        'LNG_PAGE_LIST_CONTACTS_OF_CONTACTS_ACTION_RESTORE_CONTACT_OF_CONTACTS': 'Restore contact of contact',
         ...
         */
        // LNG_PAGE_LIST_CONTACTS_OF_CONTACTS_ACTION_RESTORE_CONTACT
    }
};
