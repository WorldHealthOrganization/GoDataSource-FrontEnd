...
export const EnglishUsLang = {
    ...
    tokens: {
        ...
        'LNG_LAYOUT_MENU_ITEM_TRANSMISSION_CHAINS_GEO_MAP_LABEL': 'Chains of Transmission Geospatially map',
        'LNG_LAYOUT_MENU_ITEM_TRANSMISSION_CHAINS_COUNT_MAP_LABEL': 'Chains of Transmission Case Count Map',
