...
export const EnglishUsLang = {
    ...
    tokens: {
        ...
        'LNG_ADDRESS_FIELD_LABEL_TYPE_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_ADDRESS_FIELD_LABEL_DATE': 'Date',
        'LNG_ADDRESS_FIELD_LABEL_DATE_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_ADDRESS_FIELD_LABEL_LOCATION': 'Area',
        'LNG_ADDRESS_FIELD_LABEL_LOCATION_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_ADDRESS_FIELD_LABEL_CITY': 'City',
        'LNG_ADDRESS_FIELD_LABEL_CITY_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_ADDRESS_FIELD_LABEL_POSTAL_CODE': 'ZIP',
        'LNG_ADDRESS_FIELD_LABEL_POSTAL_CODE_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_ADDRESS_FIELD_LABEL_ADDRESS_LINE_1': 'Address',
        'LNG_ADDRESS_FIELD_LABEL_ADDRESS_LINE_1_DESCRIPTION': 'TEST_DESCRIPTION',
        ...
        'LNG_DOCUMENT_FIELD_LABEL_DOCUMENT_TYPE_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_DOCUMENT_FIELD_LABEL_DOCUMENT_NUMBER': 'Document Number',
        'LNG_DOCUMENT_FIELD_LABEL_DOCUMENT_NUMBER_DESCRIPTION': 'TEST_DESCRIPTION',
        ...
        'LNG_OUTBREAK_FIELD_LABEL_DAYS_NEW_CONTACT_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_OUTBREAK_FIELD_LABEL_NAME': 'Name',
        'LNG_OUTBREAK_FIELD_LABEL_NAME_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_OUTBREAK_FIELD_LABEL_DISEASE': 'Disease',
        'LNG_OUTBREAK_FIELD_LABEL_DISEASE_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_OUTBREAK_FIELD_LABEL_COUNTRIES': 'Countries',
        'LNG_OUTBREAK_FIELD_LABEL_COUNTRIES_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_OUTBREAK_FIELD_LABEL_START_DATE': 'Start Date',
        'LNG_OUTBREAK_FIELD_LABEL_START_DATE_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_OUTBREAK_FIELD_LABEL_END_DATE': 'End Date',
        'LNG_OUTBREAK_FIELD_LABEL_END_DATE_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_OUTBREAK_FIELD_LABEL_ACTIVE': 'Active?',
        'LNG_OUTBREAK_FIELD_LABEL_ACTIVE_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_OUTBREAK_FIELD_LABEL_DESCRIPTION': 'Description',
        'LNG_OUTBREAK_FIELD_LABEL_DESCRIPTION_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_OUTBREAK_FIELD_LABEL_DURATION_FOLLOWUP_DAYS': 'Duration for the follow-up ( days )',
        'LNG_OUTBREAK_FIELD_LABEL_DURATION_FOLLOWUP_DAYS_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_OUTBREAK_FIELD_LABEL_FOLLOWUP_FRECQUENCY': 'Follow-up frecquency',
        'LNG_OUTBREAK_FIELD_LABEL_FOLLOWUP_FRECQUENCY_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_OUTBREAK_FIELD_LABEL_FOLLOWUP_FRECQUENCY_PER_DAY': 'Follow-up frecquency per day',
        'LNG_OUTBREAK_FIELD_LABEL_FOLLOWUP_FRECQUENCY_PER_DAY_DESCRIPTION': 'TEST_DESCRIPTION',
        ...
        'LNG_OUTBREAK_FIELD_LABEL_DAYS_AMONG_KNOWN_CONTACTS_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_OUTBREAK_FIELD_LABEL_DAYS_IN_KNOWN_TRANSMISSION_CHAINS': 'Days in known transmission chains',
        'LNG_OUTBREAK_FIELD_LABEL_DAYS_IN_KNOWN_TRANSMISSION_CHAINS_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_OUTBREAK_FIELD_LABEL_DAYS_NOT_SEEN': 'Days not seen',
        'LNG_OUTBREAK_FIELD_LABEL_DAYS_NOT_SEEN_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_OUTBREAK_FIELD_LABEL_LESS_THAN_X_CONTACTS': 'Less than X contacts',
        'LNG_OUTBREAK_FIELD_LABEL_LESS_THAN_X_CONTACTS_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_OUTBREAK_FIELD_LABEL_DAYS_LONG_PERIODS': 'Long Periods ( days )',
        'LNG_OUTBREAK_FIELD_LABEL_DAYS_LONG_PERIODS_DESCRIPTION': 'TEST_DESCRIPTION',
        ...
        'LNG_CASE_FIELD_LABEL_DATE_OF_INFECTION_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CASE_FIELD_LABEL_DATE_OF_OUTCOME': 'Date of Outcome',
        'LNG_CASE_FIELD_LABEL_DATE_OF_OUTCOME_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CASE_FIELD_LABEL_AGE': 'Age',
        'LNG_CASE_FIELD_LABEL_AGE_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CASE_FIELD_LABEL_FIRST_NAME': 'First Name',
        'LNG_CASE_FIELD_LABEL_FIRST_NAME_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CASE_FIELD_LABEL_DATE_OF_ONSET': 'Date of Onset',
        'LNG_CASE_FIELD_LABEL_DATE_OF_ONSET_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CASE_FIELD_LABEL_IS_DATE_OF_ONSET_APPROXIMATE': 'Is date of onset approximate?',
        'LNG_CASE_FIELD_LABEL_IS_DATE_OF_ONSET_APPROXIMATE_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CASE_FIELD_LABEL_RISK_REASON': 'Risk Reason',
        'LNG_CASE_FIELD_LABEL_RISK_REASON_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CASE_FIELD_LABEL_RISK_LEVEL': 'Risk level',
        'LNG_CASE_FIELD_LABEL_RISK_LEVEL_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CASE_FIELD_LABEL_HOSPITALIZATION_DATES': 'Hospitalization Dates',
        'LNG_CASE_FIELD_LABEL_HOSPITALIZATION_DATES_FROM_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CASE_FIELD_LABEL_HOSPITALIZATION_DATES_TO_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CASE_FIELD_LABEL_ID': 'ID',
        'LNG_CASE_FIELD_LABEL_DOB': 'Date of Birth',
        'LNG_CASE_FIELD_LABEL_DOB_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CASE_FIELD_LABEL_DATE_BECOME_CASE': 'Date of Becoming case',
        'LNG_CASE_FIELD_LABEL_DATE_BECOME_CASE_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CASE_FIELD_LABEL_MIDDLE_NAME': 'Middle Name',
        'LNG_CASE_FIELD_LABEL_MIDDLE_NAME_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CASE_FIELD_LABEL_DELETED': 'Deleted',
        'LNG_CASE_FIELD_LABEL_TYPE': 'Type',
        'LNG_CASE_FIELD_LABEL_PHONE_NUMBER': 'Phone Number',
        'LNG_CASE_FIELD_LABEL_PHONE_NUMBER_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CASE_FIELD_LABEL_GENDER': 'Gender',
        'LNG_CASE_FIELD_LABEL_GENDER_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CASE_FIELD_LABEL_CLASSIFICATION': 'Classification',
        'LNG_CASE_FIELD_LABEL_CLASSIFICATION_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CASE_FIELD_LABEL_OCCUPATION': 'Occupation',
        'LNG_CASE_FIELD_LABEL_OCCUPATION_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CASE_FIELD_LABEL_DECEASED': 'Deceased',
        'LNG_CASE_FIELD_LABEL_DECEASED_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CASE_FIELD_LABEL_LAST_NAME': 'Last Name',
        'LNG_CASE_FIELD_LABEL_LAST_NAME_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CASE_FIELD_LABEL_DATE_DECEASED': 'Date of Decease',
        'LNG_CASE_FIELD_LABEL_DATE_DECEASED_DESCRIPTION': 'TEST_DESCRIPTION',
        ...
        'LNG_CASE_FIELD_LABEL_ISOLATION_DATES_FROM_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CASE_FIELD_LABEL_ISOLATION_DATES_TO_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CASE_FIELD_LABEL_DOCUMENTS': 'Documents',
        'LNG_CASE_FIELD_LABEL_DATE_OF_REPORTING': 'Date of reporting',
        'LNG_CASE_FIELD_LABEL_DATE_OF_REPORTING_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CASE_FIELD_LABEL_DATE_OF_REPORTING_APPROXIMATE': 'Is Date of reporting approximate',
        'LNG_CASE_FIELD_LABEL_DATE_OF_REPORTING_APPROXIMATE_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CASE_FIELD_LABEL_TRANSFER_REFUSED': 'Refused transfer to treatment unit',
        'LNG_CASE_FIELD_LABEL_TRANSFER_REFUSED_DESCRIPTION': 'TEST_DESCRIPTION',
        ...
        'LNG_CASE_LAB_RESULT_FIELD_LABEL_SAMPLE_LAB_ID_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CASE_LAB_RESULT_FIELD_LABEL_DATE_SAMPLE_TAKEN': 'Sample taken',
        'LNG_CASE_LAB_RESULT_FIELD_LABEL_DATE_SAMPLE_TAKEN_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CASE_LAB_RESULT_FIELD_LABEL_DATE_SAMPLE_DELIVERED': 'Sample delivered to lab',
        'LNG_CASE_LAB_RESULT_FIELD_LABEL_DATE_SAMPLE_DELIVERED_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CASE_LAB_RESULT_FIELD_LABEL_DATE_TESTING': 'Date testing',
        'LNG_CASE_LAB_RESULT_FIELD_LABEL_DATE_TESTING_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CASE_LAB_RESULT_FIELD_LABEL_DATE_OF_RESULT': 'Date of the result',
        'LNG_CASE_LAB_RESULT_FIELD_LABEL_DATE_OF_RESULT_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CASE_LAB_RESULT_FIELD_LABEL_LAB_NAME': 'Lab name',
        'LNG_CASE_LAB_RESULT_FIELD_LABEL_LAB_NAME_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CASE_LAB_RESULT_FIELD_LABEL_SAMPLE_TYPE': 'Sample type',
        'LNG_CASE_LAB_RESULT_FIELD_LABEL_SAMPLE_TYPE_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CASE_LAB_RESULT_FIELD_LABEL_TEST_TYPE': 'Test type',
        'LNG_CASE_LAB_RESULT_FIELD_LABEL_TEST_TYPE_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CASE_LAB_RESULT_FIELD_LABEL_RESULT': 'Result',
        'LNG_CASE_LAB_RESULT_FIELD_LABEL_RESULT_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CASE_LAB_RESULT_FIELD_LABEL_NOTES': 'Notes result',
        'LNG_CASE_LAB_RESULT_FIELD_LABEL_NOTES_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CASE_LAB_RESULT_FIELD_LABEL_STATUS': 'Status',
        'LNG_CASE_LAB_RESULT_FIELD_LABEL_STATUS_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CASE_LAB_RESULT_FIELD_LABEL_QUANTITATIVE_RESULT': 'Quantitative Result',
        'LNG_CASE_LAB_RESULT_FIELD_LABEL_QUANTITATIVE_RESULT_DESCRIPTION': 'TEST_DESCRIPTION',
        ...
        'LNG_CLUSTER_FIELD_LABEL_NAME_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CLUSTER_FIELD_LABEL_DESCRIPTION': 'Description',
        'LNG_CLUSTER_FIELD_LABEL_DESCRIPTION_DESCRIPTION': 'TEST_DESCRIPTION',
        ...
        'LNG_LOCATION_FIELD_LABEL_NAME_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_LOCATION_FIELD_LABEL_SYNONYMS': 'Synonyms',
        'LNG_LOCATION_FIELD_LABEL_SYNONYM': 'Synonym',
        'LNG_LOCATION_FIELD_LABEL_SYNONYM_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_LOCATION_FIELD_LABEL_GEO_LOCATION': 'Lat / Lng',
        'LNG_LOCATION_FIELD_LABEL_GEO_LOCATION_LAT': 'Latitude',
        'LNG_LOCATION_FIELD_LABEL_GEO_LOCATION_LAT_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_LOCATION_FIELD_LABEL_GEO_LOCATION_LNG': 'Longitude',
        'LNG_LOCATION_FIELD_LABEL_GEO_LOCATION_LNG_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_LOCATION_FIELD_LABEL_ACTIVE': 'Active',
        'LNG_LOCATION_FIELD_LABEL_ACTIVE_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_LOCATION_FIELD_LABEL_POPULATION_DENSITY': 'Population Density',
        'LNG_LOCATION_FIELD_LABEL_POPULATION_DENSITY_DESCRIPTION': 'TEST_DESCRIPTION',
        ...
        'LNG_USER_FIELD_LABEL_FIRST_NAME_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_USER_FIELD_LABEL_LAST_NAME': 'Last Name',
        'LNG_USER_FIELD_LABEL_LAST_NAME_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_USER_FIELD_LABEL_EMAIL': 'Email',
        'LNG_USER_FIELD_LABEL_EMAIL_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_USER_FIELD_LABEL_ROLES': 'Roles',
        'LNG_USER_FIELD_LABEL_ROLES_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_USER_FIELD_LABEL_ACTIVE_OUTBREAK': 'Active Outbreak',
        'LNG_USER_FIELD_LABEL_ACTIVE_OUTBREAK_DESCRIPTION': 'TEST_DESCRIPTION',
        ...
        'LNG_CONTACT_FIELD_LABEL_FIRST_NAME_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CONTACT_FIELD_LABEL_LAST_NAME': 'Last Name',
        'LNG_CONTACT_FIELD_LABEL_LAST_NAME_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CONTACT_FIELD_LABEL_AGE': 'Age',
        'LNG_CONTACT_FIELD_LABEL_AGE_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CONTACT_FIELD_LABEL_GENDER': 'Gender',
        'LNG_CONTACT_FIELD_LABEL_GENDER_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CONTACT_FIELD_LABEL_PHONE': 'Phone',
        'LNG_CONTACT_FIELD_LABEL_PHONE_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CONTACT_FIELD_LABEL_RISK_LEVEL': 'Risk Level',
        'LNG_CONTACT_FIELD_LABEL_RISK_LEVEL_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CONTACT_FIELD_LABEL_DELETED': 'Deleted',
        'LNG_CONTACT_FIELD_LABEL_RISK_REASON': 'Reason',
        'LNG_CONTACT_FIELD_LABEL_RISK_REASON_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CONTACT_FIELD_LABEL_MIDDLE_NAME': 'Middle name',
        'LNG_CONTACT_FIELD_LABEL_MIDDLE_NAME_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CONTACT_FIELD_LABEL_PHONE_NUMBER': 'Phone number',
        'LNG_CONTACT_FIELD_LABEL_PHONE_NUMBER_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CONTACT_FIELD_LABEL_OCCUPATION': 'Occupation',
        'LNG_CONTACT_FIELD_LABEL_OCCUPATION_DESCRIPTION': 'TEST_DESCRIPTION',
        ...
        'LNG_CONTACT_FIELD_LABEL_DOB': 'Date of Birth',
        'LNG_CONTACT_FIELD_LABEL_DOB_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CONTACT_FIELD_LABEL_DATE_OF_BIRTH_BUTTON': 'Date of birth',
        'LNG_CONTACT_FIELD_LABEL_DATE_OF_REPORTING': 'Date of reporting',
        'LNG_CONTACT_FIELD_LABEL_DATE_OF_REPORTING_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_CONTACT_FIELD_LABEL_DATE_OF_REPORTING_APPROXIMATE': 'Is Date of reporting approximate',
        'LNG_CONTACT_FIELD_LABEL_DATE_OF_REPORTING_APPROXIMATE_DESCRIPTION': 'TEST_DESCRIPTION',
        ...
        'LNG_RELATIONSHIP_FIELD_LABEL_CONTACT_DATE_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_RELATIONSHIP_FIELD_LABEL_CONTACT_DATE_ESTIMATED': 'Is Contact Date Estimated?',
        'LNG_RELATIONSHIP_FIELD_LABEL_CONTACT_DATE_ESTIMATED_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_RELATIONSHIP_FIELD_LABEL_CERTAINTY_LEVEL': 'Certainty Level',
        'LNG_RELATIONSHIP_FIELD_LABEL_CERTAINTY_LEVEL_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_RELATIONSHIP_FIELD_LABEL_EXPOSURE_TYPE': 'Exposure Type',
        'LNG_RELATIONSHIP_FIELD_LABEL_EXPOSURE_TYPE_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_RELATIONSHIP_FIELD_LABEL_EXPOSURE_FREQUENCY': 'Exposure Frequency',
        'LNG_RELATIONSHIP_FIELD_LABEL_EXPOSURE_FREQUENCY_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_RELATIONSHIP_FIELD_LABEL_EXPOSURE_DURATION': 'Exposure Duration',
        'LNG_RELATIONSHIP_FIELD_LABEL_EXPOSURE_DURATION_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_RELATIONSHIP_FIELD_LABEL_RELATION': 'Relation',
        'LNG_RELATIONSHIP_FIELD_LABEL_RELATION_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_RELATIONSHIP_FIELD_LABEL_CLUSTER': 'Cluster',
        'LNG_RELATIONSHIP_FIELD_LABEL_CLUSTER_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_RELATIONSHIP_FIELD_LABEL_COMMENT': 'Comment',
        'LNG_RELATIONSHIP_FIELD_LABEL_COMMENT_DESCRIPTION': 'TEST_DESCRIPTION',
        ...
        'LNG_FOLLOW_UP_FIELD_LABEL_DATE_DESCRIPTION': 'TEST_DESCRIPTION',
        ...
        'LNG_FOLLOW_UP_FIELD_LABEL_PERFORMED_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_FOLLOW_UP_FIELD_LABEL_LOST_TO_FOLLOW_UP': 'Lost to Follow-up',
        'LNG_FOLLOW_UP_FIELD_LABEL_LOST_TO_FOLLOW_UP_DESCRIPTION': 'TEST_DESCRIPTION',
        ...
        'LNG_EVENT_FIELD_LABEL_NAME_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_EVENT_FIELD_LABEL_DATE': 'Date',
        'LNG_EVENT_FIELD_LABEL_DATE_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_EVENT_FIELD_LABEL_DESCRIPTION': 'Description',
        'LNG_EVENT_FIELD_LABEL_DESCRIPTION_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_EVENT_FIELD_LABEL_ADDRESS': 'Address',
        'LNG_EVENT_FIELD_LABEL_DATE_OF_REPORTING': 'Date of reporting',
        'LNG_EVENT_FIELD_LABEL_DATE_OF_REPORTING_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_EVENT_FIELD_LABEL_DATE_OF_REPORTING_APPROXIMATE': 'Is Date of reporting approximate',
        'LNG_EVENT_FIELD_LABEL_DATE_OF_REPORTING_APPROXIMATE_DESCRIPTION': 'TEST_DESCRIPTION',
        ...
        'LNG_REFERENCE_DATA_ENTRY_FIELD_LABEL_VALUE_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_REFERENCE_DATA_ENTRY_FIELD_LABEL_DESCRIPTION': 'Description',
        'LNG_REFERENCE_DATA_ENTRY_FIELD_LABEL_DESCRIPTION_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_REFERENCE_DATA_ENTRY_FIELD_LABEL_ICON': 'Icon',
        'LNG_REFERENCE_DATA_ENTRY_FIELD_LABEL_ICON_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_REFERENCE_DATA_ENTRY_FIELD_LABEL_COLOR': 'Color',
        'LNG_REFERENCE_DATA_ENTRY_FIELD_LABEL_COLOR_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_REFERENCE_DATA_ENTRY_FIELD_LABEL_ACTIVE': 'Active',
        'LNG_REFERENCE_DATA_ENTRY_FIELD_LABEL_ACTIVE_DESCRIPTION': 'TEST_DESCRIPTION',
        ...
        'LNG_TEMPLATE_QUESTION_FIELD_LABEL_TEXT_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_TEMPLATE_QUESTION_FIELD_LABEL_VARIABLE': 'Variable',
        'LNG_TEMPLATE_QUESTION_FIELD_LABEL_VARIABLE_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_TEMPLATE_QUESTION_FIELD_LABEL_CATEGORY': 'Category',
        'LNG_TEMPLATE_QUESTION_FIELD_LABEL_CATEGORY_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_TEMPLATE_QUESTION_FIELD_LABEL_ANSWER_TYPE': 'Answer Type',
        'LNG_TEMPLATE_QUESTION_FIELD_LABEL_ANSWER_TYPE_DESCRIPTION': 'TEST_DESCRIPTION',
        ...
        'LNG_TEMPLATE_QUESTION_ANSWER_FIELD_LABEL_LABEL_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_TEMPLATE_QUESTION_ANSWER_FIELD_LABEL_VALUE': 'Answer Value',
        'LNG_TEMPLATE_QUESTION_ANSWER_FIELD_LABEL_VALUE_DESCRIPTION': 'TEST_DESCRIPTION',
        ...
        'LNG_PAGE_RESET_PASSWORD_FIELD_LABEL_NEW_PASSWORD_DESCRIPTION': 'TEST_DESCRIPTION',
        'LNG_PAGE_RESET_PASSWORD_FIELD_LABEL_CONFIRM_NEW_PASSWORD': 'Confirm New Password',
        'LNG_PAGE_RESET_PASSWORD_FIELD_LABEL_CONFIRM_NEW_PASSWORD_DESCRIPTION': 'TEST_DESCRIPTION',
        ...
        'LNG_PAGE_DASHBOARD_KPI_DASHLET_MENU_MOVE_AFTER_LABEL': 'Move after',
        'LNG_PAGE_DASHBOARD_KPI_CONTACTS_FOLLOWUP_LIST_TITLE': 'CONTACTS ON THE FOLLOW-UP LIST',
        'LNG_PAGE_DASHBOARD_KPI_CONTACTS_WITH_SUCCESSFUL_FOLLOW_UP': 'CONTACTS WITH SUCCESSFUL FOLLOW-UP ON ',
        ...
        'LNG_PAGE_DASHBOARD_KPI_CASES_LESS_CONTACTS_TITLE_AFTER_VALUE': ' CONTACTS',
        'LNG_PAGE_DASHBOARD_KPI_NEW_CASES_PREVIOUS_DAYS_TRANSMISSION_CHAINS_BEFORE_VALUE': 'NEW CASES IN THE PREVIOUS ',
        'LNG_PAGE_DASHBOARD_KPI_NEW_CASES_PREVIOUS_DAYS_TRANSMISSION_CHAINS_AFTER_VALUE': ' DAYS IN KNOWN TRANSMISSION CHAINS',
        ...
        'LNG_PAGE_DASHBOARD_CHAINS_OF_TRANSMISSION_TIMELINE_NETWORK_VIEW': 'Timeline Network',
