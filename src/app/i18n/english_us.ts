export const EnglishUsLang = {
  ...
  tokens: {
    ...
    'LNG_PAGE_LIST_RANGE_FOLLOW_UPS_FIELD_LABEL_PERSON_TYPE': 'Person type',
    'LNG_PAGE_LIST_RANGE_FOLLOW_UPS_FIELD_LABEL_OCCUPATION': 'Occupation',
    'LNG_PAGE_LIST_RANGE_FOLLOW_UPS_FIELD_LABEL_RISK': 'Risk',
    'LNG_PAGE_LIST_RANGE_FOLLOW_UPS_FIELD_LABEL_FOLLOW_UP': 'Follow-up',
    'LNG_COMMON_LABEL_STATUSES': 'Status details'
